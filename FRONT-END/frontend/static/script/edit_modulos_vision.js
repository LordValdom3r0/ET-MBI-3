    ...
    fetch(dominio + "/api/get/" + DBEVENT + "/modulos_fusibles/ID/=/" + edit_id + "/_/=/_")
        ...
        .then(data => {
                ...
                if (keys[i] == 'ID' || keys[i] == 'MODULO') {
                    ...
                    if (data[keys[i]] == '{}') {
                        ...
                        for (var j = 0; j < fusibles.length; j++) {
                            ...
                            fuses_value[caja_name][fusibles[j]] = JSON.parse(data[keys[i]])[caja_name][fusibles[j]]
                            cargar_recuadros();
            ...
            function cargar_recuadros() {
                ...
                if (caja_name == "F96" && JSON.parse(data[keys[i]])[caja_name][fusibles[j]] != "vacio") {
                    // console.log("AQUI ESTÁ LA CAJA F96");
                    f96_array.push(fusibles[j]);
                    // console.log("F96 ARRAY NUEVO: ",f96_array);
                    cargar_imagen_f96();
                }
                if (caja_name == "PDC-S" && JSON.parse(data[keys[i]])[caja_name][fusibles[j]] != "vacio") {
        ...
        img.onload = function() {
            ...
            img_f96.onmouseup = function(event) {
                ...
                for (i = 0; i < keys_f96.length; i++) {
                    ...
                    /*🍕🍕🍕🍕if (f96_array.length != 0 && f96_array.indexOf(element) != -1) {
...
function add_module_vision() {
    ...
    if (modulo_db.length == 0) {
        ...
        //     console.log(data);
        //     location.replace("numeroparte.html")
        // })
        // .catch(function(err) {
        //     console.log(err);
        // });
