...
function change_caja_pdce(){
    ...
    if(document.getElementById('pdce_option').value==='PDC-E'){
        ...
        for (let i = 0; i < keys_PDCE.length; i++) {
            // console.log("keys_PDCE[i]",keys_PDCE[i])
            // console.log("Fusible: ",fuses_value["PDC-E"][keys_PDCE[i]])
            fuses_value["PDC-E"][keys_PDCE[i]] = "empty";
        }
        pdce_array=[]
        pdce_amg_array=[]
        cargar_imagen_pdce();
    ...
    if(document.getElementById('pdce_option').value==='PDC-E_AMG'){
        ...
        console.log("keys_PDCE",keys_PDCEAMG)
...
function restaurar_f96(ctx,img_f96){
    var datosimagen = ctx.getImageData(0,0,imgWidth_f96,imgHeight_f96);
    var datos = datosimagen.data;
    for (var i = 0; i < datos.length; i++) {
...
function cargar_imagen_pdce_amg(){
    if (img_pdce_amg.getContext) {
        ...
        var img = new Image();
        img.src = "static/content/cajas/motor/PDC-E_AMG/PDC-E_AMG.jpg";
        img.onload = function(){
...
$("#verde_ato_pdcs1").on("click",function(){
    color = "ATO,30,green";
    color_style = "#008000";
    console.log("Color seleccionado: ",color)
    caja = "pdcs1";
...
$("#natural_ato_pdcs1").on("click",function(){
    color = "ATO,25,white";
    color_style = "#FFFFFF";
    console.log("Color seleccionado: ",color)
    caja = "pdcs1";
