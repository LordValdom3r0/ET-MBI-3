...
<!--====  End of LOGIN de Usuarios  ====-->
      ...
      <div class="row">
        <div class="col-xs-12 text-center breadsec">
          ...
          <div class="breadCumpNav">
            ...
            <i class="fa fa-angle-right"></i>
            <a href="trazabilidad.php">Trazabilidad</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="registros" class="container" align="left" style="display: block;">
    ...
    <div>
      <br>
      <h3>Trazabilidad - Inserción</h3>
      <hr>
      <label>1.-Para cargar un registro en específico al servidor haga click sobre el icono <span><img src="static/content/visualupload.jpg" alt="visual icono 1"></span> correspondiente.</label>
      <br>
      <label>2.-Para cargar todos los registros disponibles, presione el siguiente botón:</label>
      <br>
      <button type="button" class="btn btn-success" id="cargar_todo_insercion" style="display: none;">Cargar Todos los Registros de insercion</button>
      <button type="button" class="btn btn-success" id="cargar_todo_vision" style="display: none;">Cargar Todos los Registros de Visión</button>
      <br>
    </div>
    <div id="tabla"></div>
  </div>
        ...
        <div class="modal-body">
          ...
          <div id="mod_vision" class="panel-collapse collapse">
            <div class="panel-body">
              ...
              <p> Vaya a la sección de módulos de insercion para agregar módulos de insercion a la orden.</p>
            </div>
          </div>
          <!-- Sección de MÓDULOS DE insercion -->
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#mod_insercion">MODULOS DE insercion <hr></a>
            </h4>
          </div>
          <div id="mod_insercion" class="panel-collapse collapse">
            <div class="panel-body">
              <p> Busque el módulo en la siguiente lista, después dé click en agregar  </p>
              <select id="modulos_insercion" >
                <option selected> Seleccione un modulo de insercion...</option>
              </select>
              <div class="botonesaq">
              ...
              <div id="arreglomt">Módulos de insercion agregados:    </div>
...
<script  type="text/javascript" src="static/script/trazabilidad.js"></script>
</body>
</html>