...
<body class="index" onload="sesion_4();loadEvents()">
      ...
      <div class="row">
        <div class="col-xs-12 text-center breadsec">
          ...
          <div class="breadCumpNav">
            ...
            <i class="fa fa-angle-right"></i>
            <a href="automatico.php">Automático</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="registros" class="container" align="left" style="display: block;">
    <div class="searching">
      <div class="color flex-box">
        <button onclick="searchDAT()"> <i class='fa fa-search'></i> </button><input type="text" name="searchDAT"
          id="searchDAT" placeholder="Buscar Pedido (ILX O IRX)" onkeypress="acceptEnter()">
      </div>
    </div>
  ...
  <hr>
    ...
    <div class="container alert alert-danger alert-dismissible" id="ilx_fail" style="display: none;">
      ...
      <strong>Las siguientes modularidades no han sido cargadas a la estación debido a que contienen módulos que no
        existen en la base de datos:</strong> <br />Módulos de Inserción--><span
        style="border-image: initial; border: 2px solid gray;"></span>
    ...
    <div class="container" id="container_principal">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team_sect">
        <div class="eventos">
          <figure>
            <div><button type="button" class="btn btn-primary" id="mostrar" data-toggle="modal"
                data-target="#modal_new_event" style="display: none;"></div>
            ...
            <img src="static/content/newfase.png" onmouseover="this.style.cursor='pointer'" alt="Agregar Evento"
              id="new_event_img" />
          </figure>
        </div>
  ...
  <div class="modal fade" id="modal_new_event" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
        ...
        <div class="modal-body">
          <form id="add_event" class="text-center" style="margin: 10px 50px" onsubmit=" return false">
            <div>
              ...
              <input type="text" placeholder="Ingrese el nombre del evento. Ejemplo: (BL3)" id="new_event_name"
                required>
              <br>
...
<!--====================================================
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div style="margin: 1rem;">
          <strong>Las siguientes modularidades no han sido cargadas a la estación debido a que contienen módulos que no
            existen en la base de datos:</strong> 
            <br>
            <div>
              Módulos de Inserción -->
              <span style="border-image: initial; border: 2px solid gray;"></span>
            </div>
        </div> 
  ...
  =====================================================-->
  <div class="modal fade" id="modal_cargar_info" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#cargar_determinantes">1.-CARGAR MÓDULOS
                DETERMINANTES
                <hr></a>
            </h4>
          </div>
        <div id="cargar_determinantes" class="panel-collapse collapse">
            <div class="panel-body">
              ...
              <div id="drop-area-determinantes">
                <div style="text-align: center;padding: 100px;">
                  ...
                  <div class="loadingFile" id="loadingFile_d" style="display: none;"><img
                      src="static/content/loader.gif" alt="loading"></div>
                ...
                <div class="text-center">
                  <button type="button" class="btn btn-secondary"
                    onclick="clear_archivo_determinantes()">Cancelar</button>
          ...
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#cargar_excel">2.-CARGAR MÓDULOS (EXCEL)
                <hr></a>
            </h4>
          </div>
          <div id="cargar_excel" class="panel-collapse collapse">
            <div class="panel-body">
              <label>
                <p>Haga "Click" en el cuadro de búsqueda para abrir el explorador de Windows y seleccionar un archivo, o
                  arrastre desde la carpeta.</p>
              </label>
              <div id="drop-area-modulos">
                <div style="text-align: center;padding: 100px;">
                  <input type="file" id="cargar_input_modulos" onchange="handleFiles_modulos(this.files)">
                  <div class="loadingFile" id="loadingFile" style="display: none;"><img src="static/content/loader.gif"
                      alt="loading"></div>
          ...
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#cargar_dat">3.-CARGAR MODULARIDADES (.DAT)
                <hr></a>
            </h4>
          </div>
          <div id="cargar_dat" class="panel-collapse collapse">
            <div class="panel-body">
              <label>
                <p id="informacion_cargar">Haga "Click" en el cuadro de búsqueda para abrir el explorador de Windows y
                  seleccionar un archivo, o arrastre desde la carpeta.</p>
              </label>
              <div id="drop-area">
                <div style="text-align: center;padding: 100px;">
                ...
                <div class="text-center">
                  ...
                  <button type="button" class="btn btn-success" data-dismiss="modal"
                    onclick="update_modularities()">Finalizar</button>
                </div>
              </div>
            </div>
          </div>
  ...
  =====================================================-->
  <div class="modal fade" id="modal_ver_info" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body" align="center">
          ...
          <button type="button" class="btn btn-info btn-lg" id="ver_modularidades" style="margin: 10px"
            onclick="location.href='edit.php'">Modularidades</button>
          <!-- SECCIÓN PARA VER MÓDULOS -->
          <button type="button" class="btn btn-info btn-lg" id="ver_modulos" style="margin: 10px"
            onclick="location.href='edit_modulos.php'">Módulos</button>
          <!-- SECCIÓN PARA VER VISUALES -->
          <button type="button" class="btn btn-relx btn-lg" id="boton_visuales" style="margin: 10px"
            onclick="location.href='visuales.php'">Visuales</button>
          <!-- SECCIÓN PARA VER Modulos Determinantes -->
          <button type="button" class="btn btn-primary btn-lg" id="boton_definiciones" style="margin: 10px"
            onclick="location.href='definiciones.php'">Módulos Determinantes</button>
        </div>
        <div class="modal-footer">
        </div>
  ...
  =====================================================-->
  <div class="modal fade" id="modal_historial_info" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
