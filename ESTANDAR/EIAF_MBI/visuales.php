...
<body class="index" onload="cargartabla();sesion_4()">
      ...
      <div class="row">
        <div class="col-xs-12 text-center breadsec">
          ...
          <div class="breadCumpNav">
            ...
            <i class="fa fa-angle-right"></i>
            <a href="visuales.php">Visuales</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="contenedor_principal" class="container" align="left" style="display: block;">
    ...
    <div>
      ...
      <hr>
      <label>Para ver la visual de una modularidad haga click sobre el icono <span><img src="static/content/visual.JPG" alt="Visual Icono" width="40"></span> correspondiente.</label>
    </div>
    <div id="tabla"></div>
  </div>
...
<script  type="text/javascript" src="static/script/visuales.js"></script>
</body>
</html>