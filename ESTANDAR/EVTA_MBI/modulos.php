...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <link rel="stylesheet" type="text/css" href="static/content/modulos.css" />
...
<!--====  End of LOGIN de Usuarios  ====-->
  ...
  <div class="container" align="center" style="margin-top: 10px;">
    ...
    <button type="button" class="btn btn-info btn-lg" id="botonusuario" style="margin: 10px" onclick="redireccionModulos()">Agregar Módulos</button>
    <button type="button" class="btn btn-info btn-lg" id="botonparte" style="margin: 10px" onclick="location.href='edit_modulos.php'">Editar Módulos</button>
  ...
  =            AGREGAR MODULOS                     =
  ===============================================-->
  <!-- <div id="registros" class="container" align="center" style="display: none;">
    <button type="button" class="btn btn-success btn-lg" id="boton_modulo_vision" style="margin: 10px" onclick="redireccionModulos()">Módulos de Visión</button>
    <button type="button" class="btn btn-success btn-lg" id="boton_modulo_torque" style="margin: 10px" onclick="location.href='new_mod_t_interiorV2.php'">Módulos de Torque</button>
  </div> -->
  <div id="alertasesion" style="display: none;"></div>
  <!--====  End of AGREGAR MODULOS           ====-->
...
<script  type="text/javascript" src="static/script/modulos.js"></script>
</body>
</html>