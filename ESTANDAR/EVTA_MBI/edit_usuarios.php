...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <link rel="stylesheet" type="text/css" href="static/content/edit_usuarios.css" />
...
<!--====  End of LOGIN de Usuarios  ====-->
      ...
      <div class="row">
        <div class="col-xs-12 text-center breadsec">
          ...
          <div class="breadCumpNav">
            ...
            <i class="fa fa-angle-right"></i>
            <a href="edit_usuarios.php">Edición de Usuarios</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="modal_info" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="exampleModalCenterTitle"><span id="usuarioedit"></span></h3>
          <button type="button" id="cerrar" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="float: right;">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div align="center" id="formusuario">
            <form id="agregarusuario" style="margin: 10px 50px">
              <div>
                ...
                <select id="tipo">
                  ...
                  <option id="SUPERUSUARIO" value="SUPERUSUARIO">SUPERUSUARIO</option>
                </select>
                <br>
              </div>
            </form>
...
<script  type="text/javascript" src="static/script/edit_usuarios.js"></script>
