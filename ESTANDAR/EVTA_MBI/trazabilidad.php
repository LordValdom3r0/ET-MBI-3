...
<!--====  End of LOGIN de Usuarios  ====-->
  ...
  <div id="registros" class="container" align="left" style="display: block;">
    ...
    <div>
      ...
      <hr>
      <div align="center">
        <button type="button" class="btn btn-info btn-lg" id="lista_torque" style="margin: 10px" onclick="lista_torque()">Registros de Torque</button>
        <button type="button" class="btn btn-info btn-lg" id="lista_vision" style="margin: 10px" onclick="lista_vision()">Registros de Visión</button>
      </div>
      ...
      <br>
      <label>2.-Para cargar todos los registros disponibles, presione alguno de los siguientes botones:</label>
      <br>
      <button type="button" class="btn btn-success" id="cargar_todo_torque_trazabilidad" style="display: none;">Cargar a Trazabilidad Registros de Torque (Todos)</button>
      <button type="button" class="btn btn-success" id="cargar_todo_torque_valores" style="display: none;">Cargar Valores de Torque (Todos)</button>
