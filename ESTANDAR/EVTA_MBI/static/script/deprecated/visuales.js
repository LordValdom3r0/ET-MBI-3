  ...
  .then(data=>{
    ...
    if (data.items == 0) {
      ...
      if (colnames.includes("ACTIVO")) {
        colnames.splice(colnames.indexOf("ACTIVO"),1,"ACTIVE");  
        Object.defineProperty(data, "ACTIVE",
          Object.getOwnPropertyDescriptor(data, "ACTIVO"));
      delete data["ACTIVO"];
      }
      ...
      for (i = 0; i < filas; i++) {
        ...
        if (nombresQR.includes('PDC-D') == true || nombresQR.includes('PDC-E') == true) {
          var tr = document.createElement('TR');
