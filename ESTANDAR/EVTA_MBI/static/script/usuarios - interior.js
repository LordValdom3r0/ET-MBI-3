...
if (sessionStorage.getItem("estacion") !== "AMTC_DEDICADO"){
								...
								$.ajax({
									...
									success: function(response2) {
										...
										if ('items' in response2) {
											var nameActive,nameDate,nameType,nameName;

											console.log(estacion.ESTACION);
											if (estacion.ESTACION.includes('EVTA')) {
												nameActive = 'ACTIVO';
												nameDate   = 'DATETIME';
												nameType   = 'TYPE';
												nameName   = 'NAME';

											}else if (estacion.ESTACION.includes('EIAF')) {
												nameActive = 'ACTIVO';
												nameDate   = 'FECHA';
												nameType   = 'TIPO';
												nameName   = 'NOMBRE';
...
// async function validacion(dom, estacion){
// 	console.log(dom);

// 	//endpoint = dom+':5000' + '/api/get/usuarios/name/=/' + document.getElementById("usuario").value + '/_/=/_';
// 	endpoint = dom + '/api/get/usuarios/name/=/' + document.getElementById("usuario").value + '/gafet/=/'+ document.getElementById("gafet").value;
...
// 			})
// 			.catch(function (err) {
// 				return "Error en la consulta"+ estacion;
// 			});
// }
