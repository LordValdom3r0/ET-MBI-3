...
<!--====  End of LOGIN de Usuarios  ====-->
      ...
      <div class="row">
        <div class="col-xs-12 text-center breadsec">
          ...
          <div class="breadCumpNav">
            ...
            <i class="fa fa-angle-right"></i>
            <a href="visualesevento.php">Visuales</a>
            <i class="fa fa-angle-right"></i>
            <a href="visuales.php">Modularidades</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="registros" class="container" align="left" style="display: block;">
    ...
    <div>
      <br>
      <h3>Visuales <span id="tituloEvento"></span></h3>
      <hr>
      <label>Para ver la visual de una modularidad haga click sobre el icono <span><img src="static/content/visual1.PNG" alt="visual icono 1"></span> correspondiente, y después en: <span><img src="static/content/visual2.PNG" alt="visual icono 2" width="35"></span>  </label>
    </div>
    <div id="tabla"></div>
  </div>
