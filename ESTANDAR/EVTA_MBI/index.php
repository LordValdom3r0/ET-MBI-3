  ...
  <div class="container" align="center" id="formusuario" style="display: none;">
    <form id="agregarusuario" style="margin-top: 10px">
      <div class="contenedoragregar">
        ...
        <input type="text" placeholder="Ingrese el nombre del usuario" id="usuario" name="usuario" required>

        <label for="pass"><b>Password</b></label>
        <input type="password" id="gafet" placeholder="Ingrese el gafet" name="pass" required>
        <br>
