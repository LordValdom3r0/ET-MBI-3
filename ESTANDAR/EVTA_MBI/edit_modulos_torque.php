...
<head>
    <title>Fujikura Automotive México Piedras Negras</title>
      ...
      <link rel="stylesheet" type="text/css" href="static/content/edit_modulos_torque.css" />
...
<body class="index" onload="iniciar_pagina();sesion_3()">
      ...
      <div class="row">
        <div class="col-xs-12 text-center breadsec">
          ...
          <div class="breadCumpNav">
            ...
            <i class="fa fa-angle-right"></i>
            <a href="edit_modulos_torque.php">Módulos de Torque</a>
          </div>
        </div>
      </div>
    </div>
 ...
 <div id="caja_pdcr_options">
  ...
  <div id="caja_pdcr_mid_t" style="display: none;">
    <br/>
          <p> Usted seleccionó la caja PDC-RMID </p>
          <br/>
        ...
        <!-- <div>
          ...
          <h4> MFB-E </h4>
          <br/>
          <img id="mfbe_image" src="static/content/cajas/motor/MFB-E/MFB-E.jpg" alt="" width="1015" height="685" style="display: none;">
          <canvas id="MFB-E_image_t_canvas"></canvas>
        </div> -->
        ...
        <button type="button" class="btn btn-primary btn-lg" onclick="add_module_torque()" style="display: inline-block; margin: 10px;">Guardar Módulo</button>
      </div>
    </form>
 ...
 <!--=======================================
  ...
  <script  type="text/javascript" src="static/script/edit_modulos_torque.js"></script>
